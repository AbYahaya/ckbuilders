...
offckb deploy --network devnet --target <contract-binary-path> --output /home/abyahaya/CKBBuilder/ckbuilders/project1/offckb/deployment
```
...
```bash
# Deploy to testnet
offckb deploy --network testnet --target <contract-binary-path> --output /home/abyahaya/CKBBuilder/ckbuilders/project1/offckb/deployment
```
