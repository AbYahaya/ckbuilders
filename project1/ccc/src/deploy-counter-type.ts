...
async function main(): Promise<void> {
  ...
  const binaryPath = resolve(config.counterTypeBinaryPath);
  ...
  console.log(`COUNTER_TYPE_CODE_HASH=${codeHash}`);
  console.log("COUNTER_TYPE_HASH_TYPE=data");
  console.log(`COUNTER_TYPE_TX_HASH=${txHash}`);
  console.log("COUNTER_TYPE_TX_INDEX=0x0");
}
